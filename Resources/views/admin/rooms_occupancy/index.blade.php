            ...
            <div class="col-md-12">
                <table class="table table-striped booking-table m-t-40">
                    ...
                    <tr>
                        ...
                        <th class="text-right">{{ __('onehotel::admin.rooms_occupancy.actions') }}</th>
                    </tr>
                    </thead>
                    <tbody>
        ...
        $(document).ready(function () {
            ...
            function refreshTableData(data) {
                ...
                data.forEach(function (item) {
                    tableRows += '<tr room_id="' + item.page_id + '" item_id="' + item.id + '">' +
            ...
            function submitForm() {
                var startDate = $('#myForm #start_date').val();
                var endDate   = $('#myForm #end_date').val();
            ...
            function clearEditModalFields() {
                ...
                $('#editModal input[name="itemId"]').val('');
            }
            ...
            $(document).on('click', '.table-edit-btn', function () {
                ...
                $('#editModal input[name="itemId"]').val(data.itemId);
                $('.update-room-btn').attr('action', '/admin/hotel/room_occupancy/' + data.roomId + '/' + data.itemId + '/update/');
            ...
            $(document).on('click', '.update-room-btn', function (e) {
                ...
                var itemId = $('#editModal').find('input[name="itemId"]').val();
                ...
                $.ajax({
                    url: $('.base-url').val() + '/admin/hotel/room_occupancy/' + roomId + '/' + itemId + '/update/',
                    type: 'GET',
                    data: data,
                    success: function (response) {
                        fetchAndRenderCalendar(roomId);
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <input type="number" name="itemId" class="hidden">
